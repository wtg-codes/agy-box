...
- 🏛️ **[System Architecture Guide](docs/architecture.md)** — Detailed walkthrough of the host-to-container bridging, D-Bus session keyring pipelines, and interactive setup assistant sequence flows.
...
![Layered Architecture](docs/diagrams/system-topology.svg)
*Source: [system-topology.mmd](docs/diagrams/src/system-topology.mmd)*
...
![The Antigravity Suite](docs/diagrams/product-communication.svg)
*Source: [product-communication.mmd](docs/diagrams/src/product-communication.mmd)*
...
| **Show Port Mappings** | `agy-box-manager ports` | - |
| **System Diagnostics** | `agy-box-manager doctor` | - |
